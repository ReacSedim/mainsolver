...
%RUN_EXAMPLE3  Example 3 of Section 7.3: order of convergence, D > 0.
    ...
    nameoutfile = "ex3_order_muscl.mat";
    ...
    datos.refDiff = 'D-method-2';      % IRP-CWENO3 + SSPRK3 + two-point D datosd approx
    %%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    schemes = { 'MUSCL-D-2', 'muscl',  'ssprk2', false, 'D-method-2' ; ...
                'MUSCL-B-2', 'muscl',  'ssprk2', false, 'B-method-2'};
