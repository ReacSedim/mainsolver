...
- $`\color{#076D82}\texttt{main_solver.m}`$: Corresponds to the main source code of the solver, contains the time and spatial loops, calls all the other functions and routines and produces the output structure.
