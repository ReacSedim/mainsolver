...
- $`\color{#076D82}\tt rs\_const_functions.m`$: Contains all constitutive functions of the model plus some additional functions used in the numerical approximation.
...
- $`\color{#076D82}\tt rs\_diffusive_flux.m`$: Computes the approximation of the diffusive flux.
